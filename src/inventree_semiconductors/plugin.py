...
from plugin.mixins import NavigationMixin, PanelMixin, UrlsMixin, ActionMixin
...
class SemiconductorPlugin(NavigationMixin, PanelMixin, UrlsMixin, ActionMixin, APIView, InvenTreePlugin):
    ...
    NAVIGATION = [
        ...
        {'name': 'SampleIntegration2', 'link': 'plugin:semiconductor:increase-level', 'icon': 'fas fa-box'},
    ]
    ...
    def setup_urls(self):
        return [
            ...
            re_path(r'^api/digikey', self.api_digikey_fetch, name='api-digikey-fetch')
        ]
    ...
    def api_digikey_fetch(self, request):
